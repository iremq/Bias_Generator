...
N 520 0 690 0 {lab=#net1}
N 690 130 790 130 {lab=#net1}
N 690 0 690 130 {lab=#net1}
N 1180 -150 1180 -90 {lab=#net2}
N 1180 60 1180 360 {lab=vssa}
N 690 -0 1100 -0 {lab=#net1}
N 910 -580 1260 -580 {lab=#net3}
N 870 -550 870 40 {lab=#net4}
N 810 -580 870 -580 {lab=vssa}
N 1300 -580 1360 -580 {lab=vssa}
N 870 -660 1300 -660 {lab=vssa}
N 1300 -660 1300 -610 {lab=vssa}
N 870 -660 870 -610 {lab=vssa}
N 470 360 870 360 {lab=vssa}
N 870 360 1180 360 {lab=vssa}
N 1300 -220 1300 20 {lab=bias_VN}
N 1250 50 1300 50 {lab=vssa}
N 1250 110 1300 110 {lab=vssa}
N 1250 170 1300 170 {lab=vssa}
N 1250 230 1300 230 {lab=vssa}
N 1180 360 1300 360 {lab=vssa}
N 1300 260 1300 360 {lab=vssa}
N 1340 230 1400 230 {lab=bias_VN}
N 1400 170 1400 230 {lab=bias_VN}
N 1400 50 1400 110 {lab=bias_VN}
N 1340 110 1400 110 {lab=bias_VN}
N 1340 170 1400 170 {lab=bias_VN}
N 1400 110 1400 170 {lab=bias_VN}
N 1340 50 1400 50 {lab=bias_VN}
N 1400 -220 1400 50 {lab=bias_VN}
N 1300 -220 1400 -220 {lab=bias_VN}
N 1300 -550 1300 -220 {lab=bias_VN}
N 0 360 470 360 {lab=vssa}
N 0 -660 870 -660 {lab=vssa}
...
N 2770 -150 2800 -150 {lab=#net5}
N 3040 -150 3070 -150 {lab=#net6}
N 3110 -270 3140 -270 {lab=vdda}
N 2700 -80 2700 -40 {lab=en_VS[3]}
N 2660 -80 2660 10 {lab=en_VSB[3]}
N 2770 -220 2830 -220 {lab=bias_VN}
N 2830 -220 2830 -190 {lab=bias_VN}
N 2660 -360 2770 -360 {lab=#net7}
N 1680 -360 1680 -320 {lab=#net7}
N 1820 -360 1820 -320 {lab=#net7}
N 1680 -360 1820 -360 {lab=#net7}
N 1960 -360 1960 -320 {lab=#net7}
N 1820 -360 1960 -360 {lab=#net7}
N 2100 -360 2100 -320 {lab=#net7}
N 1960 -360 2100 -360 {lab=#net7}
N 2240 -360 2240 -320 {lab=#net7}
N 2100 -360 2240 -360 {lab=#net7}
N 2380 -360 2380 -320 {lab=#net7}
N 2240 -360 2380 -360 {lab=#net7}
N 2520 -360 2520 -320 {lab=#net7}
N 2380 -360 2520 -360 {lab=#net7}
N 2660 -360 2660 -320 {lab=#net7}
N 2520 -360 2660 -360 {lab=#net7}
N 3180 -360 3320 -360 {lab=bias_VP}
N 2700 -400 3070 -400 {lab=vssa}
N 1720 -400 1720 -320 {lab=vssa}
N 2000 -400 2000 -320 {lab=vssa}
N 2140 -400 2140 -320 {lab=vssa}
N 2280 -400 2280 -320 {lab=vssa}
N 2420 -400 2420 -320 {lab=vssa}
N 2280 -400 2420 -400 {lab=vssa}
N 2560 -400 2560 -320 {lab=vssa}
N 2420 -400 2560 -400 {lab=vssa}
N 2700 -400 2700 -320 {lab=vssa}
N 2560 -400 2700 -400 {lab=vssa}
...
N 2140 -400 2280 -400 {lab=vssa}
N 1860 -400 2000 -400 {lab=vssa}
N 2000 -400 2140 -400 {lab=vssa}
...
N 1400 -220 1650 -220 {lab=bias_VN}
N 1530 -150 1650 -150 {lab=#net8}
N 1300 -660 1720 -660 {lab=vssa}
N 1720 -660 1720 -400 {lab=vssa}
N 3070 -240 3070 -150 {lab=#net6}
N 3070 -400 3070 -300 {lab=vssa}
N 1180 -150 1470 -150 {lab=#net2}
N 3010 -220 3010 -190 {lab=bias_VN}
N 2950 -220 3010 -220 {lab=bias_VN}
N 2890 -220 2890 -190 {lab=bias_VN}
N 2830 -220 2890 -220 {lab=bias_VN}
N 2950 -220 2950 -190 {lab=bias_VN}
N 2890 -220 2950 -220 {lab=bias_VN}
N 3320 -660 3440 -660 {lab=vssa}
N 3440 -660 3440 -600 {lab=vssa}
N 3180 -660 3180 -600 {lab=vssa}
N 1720 -660 3180 -660 {lab=vssa}
N 3180 -540 3180 -470 {lab=#net9}
N 3440 -540 3440 -470 {lab=#net10}
N 3320 -570 3400 -570 {lab=bias_VP}
N 3220 -440 3400 -440 {lab=#net11}
...
N 3320 -660 3320 -650 {lab=vssa}
N 3180 -660 3320 -660 {lab=vssa}
N 3360 360 3440 360 {lab=vssa}
N 3440 170 3440 360 {lab=vssa}
N 3360 -60 3360 250 {lab=bias_VN}
N 3360 -60 3440 -60 {lab=bias_VN}
N 3440 -410 3440 -60 {lab=bias_VN}
N 3360 310 3360 360 {lab=vssa}
N 2740 360 3360 360 {lab=vssa}
N 3440 -60 3580 -60 {lab=bias_VN}
N 1860 -400 1860 -320 {lab=vssa}
N 1720 -400 1860 -400 {lab=vssa}
...
C {inv.sym} 870 -990 0 0 {name=xinv[9:0]}
...
C {ISINK.sym} 1160 -30 0 1 {name=xisink1[8:1]}
C {lab_wire.sym} 1100 -40 0 0 {name=p2 sig_type=std_logic lab=BIASGEN_en_VS
}
...
C {ipin.sym} 510 -1030 3 0 {name=p_en_cb1 lab=en_VS[10:0]}
C {iopin.sym} -20 -1030 1 0 {name=p_en_cbb2 lab=vssa}
C {iopin.sym} 70 -1030 1 0 {name=p_en_cbb3 lab=vdda}
C {lab_wire.sym} 810 -580 0 0 {name=p4 sig_type=std_logic lab=vssa
}
C {lab_wire.sym} 1360 -580 0 1 {name=p5 sig_type=std_logic lab=vssa
}
C {lab_wire.sym} 0 -660 0 0 {name=p7 sig_type=std_logic lab=vssa
}
C {sg13g2_pr/sg13_hv_nmos.sym} 1320 50 0 1 {name=M3
l=4u
w=2u
ng=1
m=1
...
C {sg13g2_pr/sg13_hv_nmos.sym} 1320 110 0 1 {name=M4
l=4u
w=2u
ng=1
m=1
...
C {sg13g2_pr/sg13_hv_nmos.sym} 1320 170 0 1 {name=M5
l=4u
w=2u
ng=1
m=1
...
C {sg13g2_pr/sg13_hv_nmos.sym} 1320 230 0 1 {name=M6
l=4u
w=2u
ng=1
m=1
...
C {lab_wire.sym} 1250 50 2 1 {name=p1 sig_type=std_logic lab=vssa
}
C {lab_wire.sym} 1250 110 2 1 {name=p9 sig_type=std_logic lab=vssa
}
C {lab_wire.sym} 1250 170 2 1 {name=p11 sig_type=std_logic lab=vssa
}
C {lab_wire.sym} 1250 230 2 1 {name=p12 sig_type=std_logic lab=vssa
}
C {SplitterCell.sym} 2760 -150 0 0 {name=x4}
C {lab_wire.sym} 1530 -220 0 0 {name=p13 sig_type=std_logic lab=bias_VN
}
...
C {devices/ammeter.sym} 1500 -150 1 0 {name=Isplit}
C {sg13g2_pr/sg13_hv_pmos.sym} 3200 -570 0 1 {name=M7
l=1u
w=4u
ng=1
m=1
...
C {sg13g2_pr/sg13_hv_pmos.sym} 3420 -570 0 0 {name=M8
l=1u
w=4u
ng=1
m=1
...
C {capa.sym} 3360 280 0 0 {name=C2
m=1
value=3p
footprint=1206
device="ceramic capacitor"}
