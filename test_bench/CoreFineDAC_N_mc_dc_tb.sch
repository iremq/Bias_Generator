...
while code_range < max_range
   ...
   * plot V_bias
   ...
   write  simulations/CoreFineDAC_N_mc_dc_tb/commandRange_\{$&initial_range\}_\{$&max\}_\{$&run\}.raw out_UP 
   write CoreFineDAC_N_mc_dc_tb/commandRange_\{$&initial_range\}_\{$&max\}_\{$&run\}.raw out_UP
end
