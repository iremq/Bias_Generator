...
N -2520 -30 -2320 -30 {lab=IREF_1uA<8:0>}
...
N -1240 60 -1140 60 {lab=VSSA}
N -1630 380 -1630 420 {lab=VSSA}
N -1630 220 -1630 320 {lab=#net11}
...
C {DecadeDivider.sym} 100 -270 0 0 {name=x1}
C {DecadeDivider.sym} 340 -270 0 0 {name=x2}
C {DecadeDivider.sym} 580 -270 0 0 {name=x3}
C {DecadeDivider.sym} 820 -270 0 0 {name=x4}
C {DecadeDivider.sym} 1060 -270 0 0 {name=x5}
C {DecadeDivider.sym} 1300 -270 0 0 {name=x6}
C {DecadeDivider.sym} 1540 -270 0 0 {name=x7}
...
C {iopin.sym} -2520 -30 2 0 {name=p16 lab=IREF_1uA<8:0>}
...
C {lab_wire.sym} -1860 -50 1 0 {name=p_vssa_ota sig_type=std_logic lab=VSSA}
...
C {lab_wire.sym} -1800 -160 0 0 {name=p_vbias_lbl sig_type=std_logic lab=VBIAS}
...
C {iopin.sym} -2250 80 1 0 {name=p_vssa1 lab=VSSA}
...
C {iopin.sym} -2590 -280 1 0 {name=p_vssa3 lab=VSSA}
