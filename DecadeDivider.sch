...
N -220 -210 -10 -210 {lab=VDDA}
N -170 50 -170 90 {lab=VSSA}
N -220 50 -220 180 {lab=IREF_CORE<1:0>}
...
N -640 -90 -290 -90 {lab=IREF}
N -640 -50 -280 -50 {lab=IREF}
C {ISOURCE.sym} -150 -120 0 0 {name=x1}
...
C {iopin.sym} -220 160 1 0 {name=p22 lab=IREF_CORE<1:0>}
C {ISOURCE.sym} -380 -120 0 0 {name=x10}
C {ISOURCE.sym} -940 -120 0 1 {name=x11}
C {iopin.sym} -980 170 0 1 {name=p2 lab=IREF}
C {lab_wire.sym} -920 90 1 0 {name=p23 sig_type=std_logic lab=VSSA}
C {ISINK.sym} -430 410 0 0 {name=x12}
C {ISINK.sym} -130 410 0 1 {name=x13}
